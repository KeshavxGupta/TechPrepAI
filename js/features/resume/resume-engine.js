    ...
    experience: [
      {
        ...
        startDate: 'May 2025',
        endDate: 'Aug 2025',
        description: 'â€¢ Architected RESTful API endpoints in Node.js & Express, improving query latency by 35%.\nâ€¢ Designed interactive dashboard analytics using React, TypeScript, and Tailwind CSS.\nâ€¢ Integrated Docker containers into CI/CD pipelines, automating automated test execution.'
      }
    ],
    projects: [
      {
        ...
        description: 'â€¢ Built a real-time collaborative code editor supporting multi-language execution and testcase sandboxing.\nâ€¢ Implemented WebSocket state synchronization for sub-50ms latency collaboration.'
      }
    ],
    education: [
      {
