        ...
        <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-900/50 transition-colors">
          ...
          <td class="py-3 px-4">
            <div class="flex items-center space-x-2">
              <a href="dsa-ide.html?p=${p.slug}" target="_blank" class="px-2.5 py-1 text-xs rounded border border-neutral-300 dark:border-neutral-700 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors font-medium">
                Test
              </a>
