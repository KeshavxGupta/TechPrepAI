    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-2 md:grid-cols-6 gap-8 mb-10">
        ...
        <div class="space-y-2">
          ...
          <ul class="space-y-1.5">
            <li><a href="dsa-sheets.html#striver" class="hover:text-neutral-900 dark:hover:text-white">Striver SDE Sheet</a></li>
            <li><a href="dsa-sheets.html#neetcode" class="hover:text-neutral-900 dark:hover:text-white">NeetCode 150</a></li>
            <li><a href="dsa-sheets.html#blind75" class="hover:text-neutral-900 dark:hover:text-white">Blind 75</a></li>
            <li><a href="dsa-sheets.html#system-design" class="hover:text-neutral-900 dark:hover:text-white">System Design 101</a></li>
          </ul>
        </div>
        ...
        <div class="space-y-2">
          ...
          <ul class="space-y-1.5">
            <li><a href="login.html" class="hover:text-neutral-900 dark:hover:text-white">Student Login</a></li>
            <li><a href="admin-hub.html" class="hover:text-neutral-900 dark:hover:text-white">Admin Panel</a></li>
            <li><a href="docs.html" class="hover:text-neutral-900 dark:hover:text-white">Documentation</a></li>
            <li><a href="partners.html" class="hover:text-neutral-900 dark:hover:text-white">College Partners</a></li>
          </ul>
        </div>
